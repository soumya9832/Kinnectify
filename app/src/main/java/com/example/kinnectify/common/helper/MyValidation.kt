package com.example.kinnectify.common.helper
...
object MyValidation {
    ...
    fun isValidEmail(context: Context, useremail: TextInputLayout): Boolean {
    ...
    fun validatePass(context: Context, userPass: TextInputLayout): Boolean {
